...
- [Thesys](https://docs.thesys.dev/guides/rendering-ui)

### Sandbox沙箱
- [Hopx](https://github.com/hopx-ai/hopx)
- [Agent-Infra](https://github.com/agent-infra/sandbox?tab=readme-ov-file)
...
|Meta Agents Research Environments: Agent环境模拟器|https://facebookresearch.github.io/meta-agents-research-environments/index.html#|
|Agent-Lightning：微软推出的AGENT RL 训练框架|https://github.com/microsoft/agent-lightning|
|Verl：字节开源的Agent RL 训练框架|https://github.com/volcengine/verl|
...
|ROMA：Roadmap规划扩展类型的多智能体，类似秘塔新出的深度搜索|https://github.com/sentient-agi/ROMA/tree/main|
|ExoAgentX:引入Prompt优化策略的agent搭建框架|https://github.com/EvoAgentX/EvoAgentX|
|Agent-FrameWork：微软开源的智能体框架|https://github.com/microsoft/agent-framework|
|Deepagents：Langchain升级版融合了langgraph的特性|https://github.com/langchain-ai/deepagents|
|TinyTroup: 微软开源了新的多智能体人格化模拟项目，可以参考多人格设计|https://github.com/microsoft/TinyTroupe/blob/main/examples/agents/Lisa.agent.json|
|LLM-council：多模型评审会|https://github.com/karpathy/llm-council|
...
|Limbic-tool-USE：lora训练好用于检测工具调用准确率的小模型|https://huggingface.co/quotientai/limbic-tool-use-0.5B-32K|
...
|AIPY：没来得及细看的基于Python交互的智能体框架|https://github.com/knownsec/aipyapp.git|
|Cognee：Langchain使用的memory框架|https://github.com/topoteretes/cognee|
|Guardrails：模型输出围栏||https://github.com/guardrails-ai/guardrails|
|AG2：Agent OS|https://github.com/ag2ai/ag2|
|SimpleMem：记忆自包含的一些概念可以借鉴|https://github.com/aiming-lab/SimpleMem|
|CLI-Anything: 个人赞同CLI是比MCP更合适的工具交互方案，|https://github.com/HKUDS/CLI-Anything|
|Symphony: Codex开源的代码审查管理的自动化Agent|https://github.com/openai/symphony/tree/main|
...
|[Presidio](https://github.com/microsoft/presidio)|微软开源的从模型推理中识别掩码隐私数据敏感数据的开源框架，OpenAI的Guardil也使用了|
...
|SPec-Kit：Code Agent|https://github.com/github/spec-kit|
|RD-Agent：已被录用的研究智能体||https://github.com/microsoft/RD-Agent|
|ScrapeCraft: langchain新推出的web爬虫agent用的scrapegraph|https://github.com/ScrapeGraphAI/scrapecraft|
|BettaFish：接入安思派的舆情分析Agent|https://github.com/666ghj/BettaFish|
|MiroFish: 提供智能体模拟舆情演变预测功能|https://github.com/666ghj/MiroFish|
...
- [TOON](https://github.com/johannschopplich/toon): 压缩JSON Token的方案，令人惊讶的是格式不native，但对效果影响不大
- [BAML](https://github.com/boundaryml/baml)：新的结构化推理语法SAP，虽然看了代码感觉核心是一套优秀的解析算法