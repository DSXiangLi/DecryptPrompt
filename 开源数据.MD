...
|Reasoning|OpenThinker的思考训练数据集|https://github.com/open-thoughts/open-thoughts|
|Agent|Jupyter Agent Dataset |https://huggingface.co/datasets/data-agents/jupyter-agent-dataset|