...
|[ALE-Bench](https://huggingface.co/datasets/SakanaAI/ALE-Bench)|算法工程评测基准：人类终于开始优化自己了|
|[SWE-Bench-Pro](https://scale.com/blog/swe-bench-pro)|更难、更真实、更多样的Coding评测基准|
|[SealQA](https://huggingface.co/datasets/vtllms/sealqa)|新的搜索问答（RAG）Benchmark|
|[Frames Benchmark](https://huggingface.co/datasets/google/frames-benchmark)|Google推出的RAG评测基准包括多跳搜索|
### 国外开源模型
|模型链接     | 模型描述    |
| --- | --- |
